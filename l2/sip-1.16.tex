...
% item b) %
\noindent\textbf{b) Resposta:} Vamos chamar de $N$ o AFN dado na questão. Seja $N_d$ o AFD equivalente à $N$.
...
A figura \ref{fig:sip1.16b} é o AFD simplificado que mostra apenas os estados que são alcançáveis a partir do estado inicial $\{1,2\}$.